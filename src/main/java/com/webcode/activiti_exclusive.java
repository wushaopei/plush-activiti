 ...
 * @Version 1.0
 */
public class activiti_exclusive {
	...
	public void deploy(){
	    ...
	    Deployment deployment=processEngine.getRepositoryService() // 部署Service
	                 ...
	                 .addClasspathResource("diagrams/MyProcess4.bpmn")  // 加载资源文件
	                 .deploy(); // 部署
    ...
    public void findTask(){
        ...
        List<Task> taskList = taskService.createTaskQuery()  // 任务相关Service // 创建任务查询
                                     .processDefinitionKey("exclusive")
	...
	public void completeTask2(){
		  ...
		  Map<String, Object> variables=new HashMap<String,Object>();
	        ...
	        processEngine.getTaskService() // 任务相关Service
	            .complete("182504", variables); //完成任务的时候，设置流程变量
    ...
    public void queryProInstanceStateByProInstanceId(){
        ProcessInstance processInstance = runtimeService.createProcessInstanceQuery().processInstanceId("182501").singleResult();
	...
	public void completeTask(){
		...
		processEngine.getTaskService().complete("195004");
	}
